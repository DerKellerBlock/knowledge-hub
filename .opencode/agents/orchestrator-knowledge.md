...
**Onboarding (vor jeder Aktion):**
1. `AGENTS.md` lesen
2. `docs/ai/README.md` lesen (Lese-Reihenfolge + Context-Loading-Rules)
3. `docs/ai/open-work.md` lesen (welche Tasks sind offen?)
4. `docs/ai/project-context.md` lesen
5. Bei Task-Bearbeitung: NUR den `docs/issues/<task-id>/`-Ordner des ausgewählten Tasks laden (spec.md + plan.md + context/), nicht alle Issues.
