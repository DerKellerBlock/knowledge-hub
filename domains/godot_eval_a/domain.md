...
Phase 3.1b Eval-Domain — Baseline (nicht-kontextualisiert). Kopie der
Godot-Quellen via relativer Symlinks auf `../../godot/sources/*.md` und
...
`chromadb_data/godot_eval_a/` und einen eigenen BM25-Index
(`godot_eval_a_bm25.pkl`), sodass der produktive `chromadb_data/godot/`-Index
unberührt bleibt. Wird von `build_index("godot_eval_a", contextualize=False)`
als Baseline gebaut.
...
- ChromaDB-Collection: `godot_eval_a_knowledge`
- Source-Types: repo
