...
Godot Engine 4.x — Noah's primary game engine. Covers API reference, 3D workflows, GDScript patterns, and personal experience from `nak-hopper-game` development.
